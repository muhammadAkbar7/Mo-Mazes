...
public class AssertJIntro extends BaseTest {
    ...
    public void simpleExamples() {
        ...
        assertThat(new int[]{0, 1, 2, 3}).containsExactly(0, 1, 2, 3);
        ...
        assertThat(Map.of(1, "A", 2, "Z", 3, " ")).hasSize(3);
    ...
    @Test
    public void basicFailingDescription() {
        assertThat(true).as("A test that always fails").isFalse();
    }

    @Test
    public void basicFailingErrorMessage() {
